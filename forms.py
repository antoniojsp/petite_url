...
class PetiteURLForms(FlaskForm):
    url = StringField(label='URL', validators=[DataRequired()], render_kw={"class":"form-control p-2s", "placeholder":"Paste here the complete URL you want to shorten"})
    ...
    custom_hash = StringField(validators=[Length(max=7)], render_kw={"placeholder":"Custom name"})
